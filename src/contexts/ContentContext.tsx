...
const defaultContent: SiteContent = {
  ...
  },
  {
    ...
    "answer": "Most Kerala diamond boutiques — including Kirthi Diamonds — are closed on Sundays. Kirthi Diamonds Kochi is open **Monday to Saturday, 10:00 to 19:00** at 34/572 By Pass Road, Palarivattom. The Calicut boutique opens slightly earlier, at 10:00am, with the same Monday-to-Saturday schedule. For Sunday and late-evening enquiries, our Diamond Specialist responds via WhatsApp at +91 98470 86990 — including by-appointment boutique visit booking, certificate verification questions, and bespoke design discussions. For urgent visits outside boutique hours, after-hours by-appointment boutique visits can be arranged on request.",
    "schemaAnswer": "Most Kerala diamond boutiques, including Kirthi Diamonds, are closed on Sundays. Kirthi Diamonds Kochi is open Monday to Saturday, 10:00 to 19:00. For Sunday queries, our Diamond Specialist responds via WhatsApp at +91 98470 86990, including for after-hours by-appointment boutique visits.",
    "category": "Purchasing & Policies"
  },
  {
  ...
  },
  {
    ...
    "answer": "Kirthi Diamonds has two boutiques in Kerala. The Kochi showroom is at 34/572, By Pass Road, Palarivattom, Ernakulam, Kerala 682024, open Monday to Saturday 10:00 am to 7:00 pm. The Calicut showroom is at 61/11508A, Opposite Federal Bank, Puthiyara, Kozhikode, Kerala 673004, open Monday to Saturday 10:00 am to 7:00 pm."
  },
  {
  ...
  calicutHours: "Mon – Sat: 09:30 AM – 7:30 PM\nClosed on Sundays",
...
export function ContentProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const listCollections = ['blogPosts', 'pageVideos', 'shopProducts', 'heritageItems', 'methodologySteps', 'brideGallery', 'journalTrends', 'faqs', 'homeFAQs'];
    let loadedCount = 0;
