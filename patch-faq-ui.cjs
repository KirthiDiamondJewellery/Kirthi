...
const fileContent = `import React, { useEffect, useState, useMemo } from 'react';
  ...
  return (
    <div className="w-full h-[100dvh] overflow-y-auto custom-scrollbar overflow-x-hidden bg-[#050505] text-[#E5E4E2] flex flex-col items-center px-4 sm:px-6 md:px-24 pb-8 md:pb-24 pt-[140px] md:pt-[200px]">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "@id": "https://kirthidiamonds.com/faq#new",
...
fs.writeFileSync('src/components/FAQView.tsx', fileContent, 'utf8');
console.log('FAQView replaced with tab-based navigation and feedback buttons.');
